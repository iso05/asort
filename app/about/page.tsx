    ...
    >
      ...
      >
        ...
        <div style={{ maxWidth: 760, position: "relative", zIndex: 2 }}>
          <p className="label hero-anim" style={{ marginBottom: 20 }}>About Asort</p>
          ...
          >
            We feed<br />
            <span style={{ color: "rgba(255,255,255,0.18)", fontStyle: "italic" }}>the world</span><br />
            with intent.
          </h1>
        ...
        >
          ...
          <Reveal>
            ...
            <h2
              ...
              style={{ fontSize: "clamp(2.5rem, 5vw, 4.5rem)", marginBottom: 28 }}
            >
              Started with<br />
              <span style={{ color: "#4a9eff" }}>one product.</span><br />
              Built on trust.
            </h2>
          </Reveal>
      ...
      <section style={{ padding: "100px 40px", maxWidth: 1280, margin: "0 auto" }}>
        <Reveal>
          <p className="label" style={{ marginBottom: 14 }}>What We Stand For</p>
          <h2
            className="big-heading"
            style={{ fontSize: "clamp(2.5rem, 5vw, 4.5rem)", marginBottom: 56 }}
          >
            Four values.<br />
            <span style={{ color: "rgba(255,255,255,0.2)" }}>Zero exceptions.</span>
          </h2>
        </Reveal>
          ...
          {VALUES.map((v, i) => (
            <Reveal key={v.title} delay={i * 80}>
              <div className="value-card">
                ...
                <p className="body-text" style={{ fontSize: 12.5, lineHeight: 1.75 }}>
                  {v.body}
                </p>
              </div>
            </Reveal>
      ...
      <section style={{ padding: "100px 40px", maxWidth: 1280, margin: "0 auto" }}>
        <Reveal>
          <p className="label" style={{ marginBottom: 14 }}>Milestones</p>
          <h2
            className="big-heading"
            style={{ fontSize: "clamp(2.5rem, 5vw, 4.5rem)", marginBottom: 64 }}
          >
            A decade of<br />
            <span style={{ color: "#4a9eff" }}>doing it right.</span>
          </h2>
        </Reveal>
                ...
                >
                  ...
                  <p
                    style={{
                      ...
                      fontWeight: 800,
                      fontSize: 28,
                      color: i === TIMELINE.length - 1 ? "#4a9eff" : "rgba(255,255,255,0.25)",
                      lineHeight: 1,
                      paddingTop: 0,
                    }}
                  >
        ...
        <style>{`
          @media (max-width: 600px) {
            .tl-row { grid-template-columns: 20px 80px 1fr !important; gap: 0 16px !important; }
          }
        `}</style>
      </section>
      ...
      <section style={{ padding: "100px 40px", maxWidth: 1280, margin: "0 auto" }}>
        <Reveal>
          <p className="label" style={{ marginBottom: 14 }}>The People</p>
          <h2
            className="big-heading"
            style={{ fontSize: "clamp(2.5rem, 5vw, 4.5rem)", marginBottom: 56 }}
          >
            Built by humans<br />
            <span style={{ color: "rgba(255,255,255,0.2)" }}>who care deeply.</span>
          </h2>
        </Reveal>
            ...
            <Reveal key={member.name} delay={i * 80}>
              <div className="team-card">
                ...
                <div
                  style={{
                    height: 160,
                    background: `linear-gradient(135deg, rgba(74,158,255,0.12) 0%, rgba(74,158,255,0.03) 100%)`,
                    display: "flex",
                    alignItems: "center",
      ...
      <section style={{ padding: "100px 40px", maxWidth: 1280, margin: "0 auto", textAlign: "center" }}>
        <Reveal>
          <p className="label" style={{ marginBottom: 16 }}>Ready to work together?</p>
          <h2
            className="big-heading"
            style={{ fontSize: "clamp(3rem, 7vw, 6rem)", marginBottom: 36 }}
          >
            Let's start<br />
            <span style={{ color: "#4a9eff" }}>a conversation.</span>
          </h2>
          <a
            href="/contact"
            style={{
      ...
      {/* ══════════════════════════════════════
          FOOTER (mini — same across all pages)
      ══════════════════════════════════════ */}
      <footer
        style={{
